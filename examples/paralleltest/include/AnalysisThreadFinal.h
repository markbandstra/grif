...
#ifndef GRIF_EXAMPLES_PARALLELTEST_ANALYSISTHREADFINAL_H_
#define GRIF_EXAMPLES_PARALLELTEST_ANALYSISTHREADFINAL_H_
...
class AnalysisThreadFinal : public GRIAnalysisThread {
...
#endif  // GRIF_EXAMPLES_PARALLELTEST_ANALYSISTHREADFINAL_H_
