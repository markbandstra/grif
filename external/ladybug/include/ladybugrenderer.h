 ...
 * Tone mapping compresses high dynamic range images to make them appear more 
 * pleasing to  the human eye. The conversion used for the mapping is based 
 * on Reinhard's tone mapping operator.
 *
 * This functionality requires OpenGL version 2.0 or later. 
 *
...
/**
 * Set the processing parameters for tone mapping.
 *
 * @param context - The LadybugContext to access.
