 ...
 * properties. This function must be called once before any calls involving 
 * 3D mapping and rectification are performed. 
 ...
 * 
 * Note that dynamic stitching is time consuming and may result in unexpected
 * effects when a search for the best distance fails. 
 *
